...
pub use decl::{
    ...
    GenericParam, ImplDecl, ImplMember, InitDecl, InitKind, MacroBlock,
    MacroClause, MacroClauseKind, MacroDecl, MacroInputKind, MacroParam,
    Modifier, ParamDecl, ParamLabel, ProtocolDecl, ProtocolFunctionMember,
