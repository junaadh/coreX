...
pub use semantic::{
    ...
    ExpressionTypeTable, ExternalSemanticLookup, Mutability, NamedTypeKind,
    SemanticAnalysis, SemanticAnalysisIssues, SignatureTypingIssue,
    SignatureTypingIssueKind, StatementKind, StatementTypeEntry,
    StatementTypeTable, StmtCheckIssue, StmtCheckIssueKind, Type,
    TypedAssociatedTypeBounds, TypedBody, TypedBodyId, TypedBodyIssueKind,
    TypedBodyIssueMarker, TypedBodyTable, TypedBodyTableIssue,
    TypedBodyTableIssueKind, TypedEnumCaseSignature, TypedEnumSignatureData,
    TypedFunctionSignature, TypedImplAttachment, TypedImplSignature,
    TypedItemData, TypedItemKind, TypedItemTable, TypedItemTableIssue,
    TypedItemTableIssueKind, TypedNamedFunctionSignature,
