...
impl<'a> ScopeResolver<'a> {
    #[must_use]
    pub fn new(db: &'a SourceDb, parsed_files: &'a [ParsedFile]) -> Self {
    ...
    fn parsed_file_by_id(&self, file_id: FileId) -> Option<&ParsedFile> {
        self.parsed_files
            .iter()
...
struct ResolveContext<'a> {
    parsed_by_id: HashMap<FileId, &'a ParsedFile>,
